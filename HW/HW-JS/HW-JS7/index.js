...
const roma = new Client('01', "Roma", "Roma", "Roma", "Roma", ["apple", "banana", "orange"]);

let clients = [];

for (let i = 0; i < 10; i++) {
    clients.push(new Client(i, `name${i}`, `surname${i}`, `email${i}`, `phone${i}`, ["apple", "banana", "orange"]));
}
...
function Car2(model, manufacturer, yearOfManufacture, maxSpeed, engineCapacity) {
    this.model = model;
    ...
    this.info = function () {
        console.log(this.yearOfManufacture, this.maxSpeed, this.engineCapacity, this.manufacturer, this.model);
    }
